...
(function () {
  ...
  const DEFAULT_HINTS = {
    ...
    clients_master: "L’annuaire central : toute personne passée par Triskell (contact, prospect, client), avec son historique complet — factures, mails échangés, projets livrés. Le démarchage, lui, se pilote depuis « Tous les prospects ».",
    ...
    eclaireur: "Outil au repos (08/07) : plus de fiches sans mail à compléter (règle du 11/06), et les chasseurs récoltent déjà les mails pendant la chasse. Écran gardé pour essais ponctuels. Aucun envoi de mail ici.",
