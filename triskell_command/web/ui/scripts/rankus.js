 ...
 * Pipeline identique à WoW (mêmes étapes, mêmes statuts).
 */

const Rankus = makePipelineView({
  apiPrefix: 'rankus',
  kicker:    'RANKUS STUDIO',
  title:     'Le pipeline SEO sous tes yeux.',
  subtitle:  'Chaque demande SEO, son étage dans le pipeline, et l\'historique pas à pas.',
