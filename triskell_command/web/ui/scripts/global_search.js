...
const GlobalSearch = {
  ...
  STATIC_VIEWS: [
    ...
    { view: 'mail_templates', params: { tab: 'transactionnel' }, label: 'Modèles · transactionnel', kind: 'view', icon: '📄',
      keywords: 'modeles modèles mails transactionnel confirmation livraison bienvenue' },
    ...
    // — Sites & SEO —
    { view: 'pixelpros',   label: 'Pixel Pros · chaîne de fabrication', kind: 'view', icon: '⭐',
      keywords: 'pixel pros sites clients kanban construction commandes' },
    { view: 'wow',         label: 'WoW · chaîne de fabrication', kind: 'view', icon: '🌊',
      keywords: 'wow studio demandes sites etapes étapes' },
    { view: 'rankus',      label: 'RankUs · chaîne de fabrication', kind: 'view', icon: '📊',
      keywords: 'rankus seo demandes etapes étapes' },
    { view: 'lagriffe',    label: 'Lagriffe · chaîne de fabrication', kind: 'view', icon: '🎨',
      keywords: 'lagriffe griffe studio demandes sites etapes étapes' },
    { view: 'phare',       label: 'Le Phare (SEO)', kind: 'view', icon: '🗼',
      keywords: 'phare seo referencement référencement audits robots sites' },
    { view: 'geo',         label: 'Le GEO', kind: 'view', icon: '🌍',
